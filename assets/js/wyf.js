...
class List {
    ...
    constructor(container, template) { 
        ...
        mustache__WEBPACK_IMPORTED_MODULE_0__["default"].parse(this.#template)
    }
    ...
    run() {
        ...
        .then(response => this.#container.innerHTML = mustache__WEBPACK_IMPORTED_MODULE_0__["default"].render(this.#template, {'items': response}))
    }
}
